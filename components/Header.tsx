...
export const Header = () => {
  ...
  return (
    <>
      <div className="h-6" />
      <div className="fixed z-10 h-6 w-full px-4" style={{ top: 0, left: 0 }}>
        <div className="m-auto flex max-w-3xl flex-row justify-between gap-2 border-b bg-background pl-2 pr-2">
          <button
